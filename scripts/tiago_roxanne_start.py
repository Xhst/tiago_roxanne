...
class TiagoRoxanneStart:

    def __init__(self, plan, agent = 'agent.properties'):
        self.node_name = 'tiago_roxanne_start'
...
if __name__ == '__main__':
    try:
        tiago_roxane_start = TiagoRoxanneStart('1table_1user.json', 'agent_dfs.properties')
        tiago_roxane_start.start()
